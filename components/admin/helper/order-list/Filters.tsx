...
import { BookingHooksType } from '@/types/booking';

export default function Filters({ state, actions }: BookingHooksType) {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 bg-white dark:bg-slate-850 p-3 lg:p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <div className="lg:col-span-5 relative group">
                ...
                <input
                    ...
                    placeholder="Tìm kiếm theo tên khách hàng, tên xe, biển số xe..."
                    type="text"
            ...
            <div className="lg:col-span-3 relative">
                ...
                >
                    ...
                    {state.bookingStatuses &&
                        state.bookingStatuses.map((status) => (
